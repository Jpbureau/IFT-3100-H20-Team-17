...
public:
	...
	bool isSelectionInShape(int select_posX, int select_posY, int shape_pos1X, int shape_pos1Y, int shape_pos2X, int shape_pos2Y);
	...
	void selectShapeZone();
	void selectShapeDot(int mouseX, int mouseY);
